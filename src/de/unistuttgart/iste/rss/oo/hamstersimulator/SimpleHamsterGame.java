 ...
 * To be used in lectures 2-8 of PSE as predefined base class. * * @author
 * Steffen Becker *
 */
public abstract class SimpleHamsterGame {
	/**
	 * * Variable inherited to child classes containing the default hamster * which
	 * is named paule here. Intentionally, no getter or setter is used * as they are
	...
	/**
	 * * Initialized a simple hamster game by loading a default territory * and
	 * setting protected references to contain the default hamster and * the game.
	 */
